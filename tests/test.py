...
def test_names_elements_registration(selenium):
    try:
        ...
        assert 'E-mail или мобильный телефо' in page_reg.card_of_registration.text
...
# # 4 Форма "Регистрация". Проверка валидных значений "Имя" и "Фамилия" _______________________________________________
...
# 12 Форма "Авторизация" при регистрации пользователем e-mail, который уже был использован ранее для регистрации____________________________
...
# 13 Форма "Регистрация" невалидными значениями в поле ввода Имени __________________________________________________
...
# 14 Форма Регистрация поле Пароль значения валидны ________________________________________________
...
# 15 Форма Регистрация поле Пароль1 Пароль повторно ____________________________________________________
